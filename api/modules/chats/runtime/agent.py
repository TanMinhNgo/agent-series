...
from agent_core.persistence.store import Chat, Project
...
def make_agent(deps: AgentDependencies, app_services: Services, chat: Chat, memory_context: str = "", knowledge_context: str = "", personalization_context: str = "", plugin_tools: list[ToolSpec] | None = None, history: list[dict[str, Any]] | None = None, schedule_proposals: list[dict[str, Any]] | None = None, allow_schedule_proposals: bool = True, artifact_edit: ArtifactEditContext | None = None, web_context: str = "", allow_web: bool = True) -> Agent:
    try:
