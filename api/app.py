...
@app.get("/api/workspaces", tags=["Workspaces"], responses=API_ERROR_RESPONSES)
...
@app.post("/api/workspaces", status_code=201, tags=["Workspaces"], responses=API_ERROR_RESPONSES)
...
@app.get("/api/workspaces/current/members", tags=["Workspaces"], responses=API_ERROR_RESPONSES)
...
@app.get("/api/workspaces/current/invitations", tags=["Workspaces"], responses=API_ERROR_RESPONSES)
...
@app.get("/api/workspaces/current/invitable-users", tags=["Workspaces"], responses=API_ERROR_RESPONSES)
...
@app.get("/api/auth/me", tags=["Authentication"], responses=API_ERROR_RESPONSES)
def auth_me(request: Request) -> dict[str, Any]:
    user = services().auth.session_user(request.cookies.get(SESSION_COOKIE))
    return {"user": user_json(user) if user else None}


@app.get("/api/auth/google/authorize", tags=["Authentication"], responses=API_ERROR_RESPONSES)
...
@app.get("/api/auth/google/callback", tags=["Authentication"], responses=API_ERROR_RESPONSES)
...
@app.post("/api/auth/logout", status_code=204, tags=["Authentication"], responses=API_ERROR_RESPONSES)
def auth_logout(request: Request, response: Response) -> None:
    services().auth.logout(request.cookies.get(SESSION_COOKIE))
    response.delete_cookie(SESSION_COOKIE, path="/")


@app.get("/api/admin/overview", tags=["System admin"], responses=API_ERROR_RESPONSES)
...
@app.get("/api/settings/api-keys", tags=["Settings"], responses=API_ERROR_RESPONSES)
def list_api_keys(request: Request) -> dict[str, Any]:
    user = getattr(request.state, "user", None)
    if user is None:
        raise HTTPException(status_code=401, detail=AUTHENTICATION_REQUIRED_ERROR)
    return {"items": [credential_json(item) for item in services().credentials.list_metadata(user.id)]}


@app.put("/api/settings/api-keys/{provider}", tags=["Settings"], responses=API_ERROR_RESPONSES)
...
@app.delete("/api/settings/api-keys/{provider}", status_code=204, tags=["Settings"], responses=API_ERROR_RESPONSES)
...
@app.get("/api/admin/users", tags=["System admin"], responses=API_ERROR_RESPONSES)
...
@app.patch("/api/admin/users/{user_id}/active", tags=["System admin"], responses=API_ERROR_RESPONSES)
...
@app.patch("/api/admin/models/{provider}/{model_id}/active", tags=["System admin"], responses=API_ERROR_RESPONSES)
...
@app.get("/api/admin/credentials", tags=["System admin"], responses=API_ERROR_RESPONSES)
...
@app.get("/api/admin/audit", tags=["System admin"], responses=API_ERROR_RESPONSES)
...
@app.get("/api/admin/plugin-connections", tags=["System admin"], responses=API_ERROR_RESPONSES)
...
@app.get("/api/health", tags=["System"], responses=API_ERROR_RESPONSES)
def health() -> dict[str, str]:
    return {"status": "ok"}


@app.get("/api/config", tags=["System"], responses=API_ERROR_RESPONSES)
...
@app.get("/api/chats", tags=["Chats"], responses=API_ERROR_RESPONSES)
def list_chats(
...
@app.post("/api/chats", status_code=201, tags=["Chats"], responses=API_ERROR_RESPONSES)
...
@app.get("/api/memories", tags=["Memory library"], responses=API_ERROR_RESPONSES)
def memories(query: str = "") -> list[dict[str, Any]]:
    return services().memory.list(query)


@app.delete("/api/memories/{memory_id}", status_code=204, tags=["Memory library"], responses=API_ERROR_RESPONSES)
...
@app.delete("/api/memories", status_code=204, tags=["Memory library"], responses=API_ERROR_RESPONSES)
def forget_all_memories() -> None:
    services().memory.forget_all()


@app.get("/api/library/assets", tags=["Personal library"], responses=API_ERROR_RESPONSES)
...
@app.get("/api/library/assets/{asset_id}/preview", tags=["Personal library"], responses=API_ERROR_RESPONSES)
...
@app.get("/api/library/assets/{asset_id}/diff", tags=["Personal library"], responses=API_ERROR_RESPONSES)
...
@app.get("/api/chats/{chat_id}/messages", tags=["Chats"], responses=API_ERROR_RESPONSES)
...
@app.post("/api/chats/{chat_id}/read", tags=["Chats"], responses=API_ERROR_RESPONSES)
...
@app.patch("/api/messages/{message_id}/pin", tags=["Chats"], responses=API_ERROR_RESPONSES)
...
@app.post("/api/messages/{message_id}/feedback", status_code=201, tags=["Chats"], responses=API_ERROR_RESPONSES)
...
@app.post("/api/chats/{chat_id}/branches", status_code=201, tags=["Chats"], responses=API_ERROR_RESPONSES)
...
@app.post("/api/chats/{chat_id}/regenerate", tags=["Chats"], responses=API_ERROR_RESPONSES)
...
@app.get("/api/chats/{chat_id}/pins", tags=["Chats"], responses=API_ERROR_RESPONSES)
...
@app.get("/api/templates", tags=["Workspace"], responses=API_ERROR_RESPONSES)
...
@app.post("/api/templates", status_code=201, tags=["Workspace"], responses=API_ERROR_RESPONSES)
...
@app.patch("/api/templates/{template_id}", tags=["Workspace"], responses=API_ERROR_RESPONSES)
...
@app.delete("/api/templates/{template_id}", status_code=204, tags=["Workspace"], responses=API_ERROR_RESPONSES)
def delete_template(template_id: str) -> None:
    if not services().workspace.delete(PromptTemplate, template_id):
        raise HTTPException(status_code=404, detail="Không tìm thấy template.")


@app.patch(CHAT_DETAIL_PATH, tags=["Chats"], responses=API_ERROR_RESPONSES)
...
@app.delete(CHAT_DETAIL_PATH, status_code=204, tags=["Chats"], responses=API_ERROR_RESPONSES)
def delete_chat(chat_id: str) -> None:
    if not services().chats.delete(chat_id):
        raise HTTPException(status_code=404, detail=CHAT_NOT_FOUND_ERROR)


@app.post("/api/chats/{chat_id}/share", tags=["Shared chats"], responses=API_ERROR_RESPONSES)
...
@app.get("/api/documents", tags=["Knowledge base"], responses=API_ERROR_RESPONSES)
def documents() -> list[dict[str, Any]]:
    jobs = BackgroundJobRepository(services().chats.database)
    return [document_json(item, jobs.latest_for_document(item.id)) for item in services().knowledge.list_documents()]


@app.get("/api/projects/{project_id}/collections", tags=["Knowledge base"], responses=API_ERROR_RESPONSES)
...
@app.post("/api/projects/{project_id}/collections", status_code=201, tags=["Knowledge base"], responses=API_ERROR_RESPONSES)
...
@app.patch("/api/collections/{collection_id}", tags=["Knowledge base"], responses=API_ERROR_RESPONSES)
...
@app.put("/api/collections/{collection_id}/documents", tags=["Knowledge base"], responses=API_ERROR_RESPONSES)
...
@app.get("/api/worker/status", tags=["System"], responses=API_ERROR_RESPONSES)
def worker_status() -> dict[str, Any]:
    return BackgroundJobRepository(services().chats.database).worker_status(datetime.now(UTC))


@app.post("/api/documents", status_code=201, tags=["Knowledge base"], responses=API_ERROR_RESPONSES)
...
@app.post("/api/documents/{document_id}/reindex", status_code=202, tags=["Knowledge base"], responses=API_ERROR_RESPONSES)
...
@app.delete("/api/documents/{document_id}", status_code=204, tags=["Knowledge base"], responses=API_ERROR_RESPONSES)
...
@app.get("/api/projects", tags=["Projects"], responses=API_ERROR_RESPONSES)
...
@app.get("/api/schedules", tags=["Schedules"], responses=API_ERROR_RESPONSES)
...
@app.get("/api/plugins", tags=["Plugins"], responses=API_ERROR_RESPONSES)
...
@app.get("/api/connectors/google", tags=["Connectors"], responses=API_ERROR_RESPONSES)
def google_connector_status() -> dict[str, Any]:
    return services().google_workspace.status()


@app.get("/api/connectors/google/audit", tags=["Connectors"], responses=API_ERROR_RESPONSES)
...
@app.delete("/api/connectors/google", status_code=204, tags=["Connectors"], responses=API_ERROR_RESPONSES)
...
@app.get("/api/connectors/github", tags=["Connectors"], responses=API_ERROR_RESPONSES)
def github_connector_status() -> dict[str, Any]:
    return services().github.status()


@app.get("/api/connectors/github/audit", tags=["Connectors"], responses=API_ERROR_RESPONSES)
...
@app.delete("/api/connectors/github", status_code=204, tags=["Connectors"], responses=API_ERROR_RESPONSES)
...
@app.get("/api/plugin-catalog", tags=["Plugin catalog"], responses=API_ERROR_RESPONSES)
...
def load_web_context(app_services: Services, chat: Chat, content: str, events: Queue) -> tuple[str, list[dict[str, str]]]:
    if chat.provider != "ollama" or not should_search_web(content): return "", []
    try:
...
def run_agent_turn(app_services: Services, chat: Chat, chat_id: str, content: str, attachments: list[dict], artifact_edit: ArtifactEditContext | None, cancel_event: Event, full_history: list[dict[str, Any]], events: Queue) -> None:
    ...
    def run() -> None:
        ...
        try:
            ...
            if static_response is not None:
                ...
                return
            run_agent_turn(app_services, chat, chat_id, content, attachments, artifact_edit, cancel_event, full_history, events)
