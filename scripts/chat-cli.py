...
def build_agent() -> Agent:
    ...
    knowledge = KnowledgeService(Database(settings.database_url), settings.knowledge_dir, settings.embedding_model)
    registry = build_default_registry(build_knowledge_tool(knowledge))
