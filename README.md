...
Production có thể tách frontend Vercel khỏi backend AWS EC2; Jenkins vẫn là release authority và chỉ deploy sau mọi gate. Xem [hướng dẫn Vercel + AWS](docs/deployment-vercel-oci.md).
